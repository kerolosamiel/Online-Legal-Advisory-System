        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.Role == SD.AdminRole)
                {
                    ...
                    user.Admin.FirstName = Input.FirstName;
                    user.Admin.LastName = Input.LastName;
                    user.Admin.Address = Input.Address;
                    user.Admin.CreatedAt = DateTime.Now;
                ...
                if (Input.Role == SD.ClientRole)
                {
                    ...
                    user.Client.CreatedAt = DateTime.Now;
                ...
                if (Input.Role == SD.LawyerRole)
                {
                    if (user.Lawyer == null)
                    {
                        user.Lawyer = new ELawyer.Models.Lawyer();
                    }


                    user.Role = SD.LawyerRole;
                    user.Lawyer.FirstName = Input.FirstName;
                    user.Lawyer.LastName = Input.LastName;


                    //user.Lawyer.AccountStatus = SD.AccountStatusActive;
                    user.Lawyer.Address = Input.Address;
                    user.Lawyer.CreatedAt = DateTime.Now;
