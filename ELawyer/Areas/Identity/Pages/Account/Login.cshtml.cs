        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ApplicationUser user = _unitOfWork.ApplicationUser.Get(a => a.Id == userId, includeproperties: "Lawyer,Admin,Client");
                    if (User.IsInRole(SD.AdminRole))
                    {
                        user.Admin.LastLogin = DateTime.Now;
                        _unitOfWork.Admin.Update(user.Admin);
                    }
                    if (User.IsInRole(SD.ClientRole))
                    {
                        user.Client.LastLogin = DateTime.Now;
                     ...
                     if (User.IsInRole(SD.LawyerRole))
                    {
                        ...
                        user.Lawyer.LastLogin = DateTime.Now;
